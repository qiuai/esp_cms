			...
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2 <?php if($this->_tpl_vars['styleid']==3){ ?>displaynone<?php } ?>">
						...
						<td width="85%" class="trtitle02">
							<textarea name="content" id="content" cols="50" rows="5" class="smallInput" style="width:98%;height:70px;"></textarea>
						</td>
					</tr>
...
<div id="downbotton">
	<div id="subbotton">
		<table border="0" width="100%">
			<tr>
				<td id="right"><input type="submit" id="typeaddsubmitbotton" name="Submit" value="<?php echo $this->_tpl_vars['ST']['botton_add'] ?>" class="button orange" /></td>
