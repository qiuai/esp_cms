...
<div class="login-div">
 <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" id="centerlogin">
    <tr>
										...
										<!--from-->
										    ...
										    <input type="hidden" name="tokenkey" value="<?php echo $this->_tpl_vars['tokenkey']['token_key'] ?>">
									            <table border="0" cellpadding="0">
									                    ...
									                    <tr>
									                            <td class="logintd"></td>
									                            <td class="logintd2"><input type="submit" class="button orange" name="button" value="<?php echo $this->_tpl_vars['ST']['adminuser_login_log_action'] ?>"/></td>
									                    </tr>
									            </table>
									            </form>
										<!--form_end-->
		...
		<div class="fotter">ESPCMS.COM 2002-2014 All Rights Reserved 后台推荐使用IE8、谷歌或Firefox浏览器</div>
    </tr>
</table>
</div>
</body>
