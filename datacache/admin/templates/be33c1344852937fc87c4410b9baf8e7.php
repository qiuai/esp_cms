...
<script type="text/javascript">
	...
	var adverttypemain_js_add_ok = "<?php echo $this->_tpl_vars['ST']['adverttypemain_js_add_ok'] ?>";
	var adverttypemain_js_add_no = "<?php echo $this->_tpl_vars['ST']['adverttypemain_js_add_no'] ?>";
	...
	function saveResponse(options){
		...
		if (options=='true'){
			...
			alert(adverttypemain_js_add_ok);
		}else{
			alert(adverttypemain_js_add_no+"("+options+")");
		}
...
<div id="mainbodybottonauto" class="managebottonadd">
	<div class="maindobycontent">
		<div class="suggestion">
			<span class="sugicon"><span class="strong colorgorning2"><?php echo $this->_tpl_vars['ST']['position_title'] ?></span><span class="colorgorningage"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_mess'] ?></span></span>
		</div>
			...
			<div class="maneditcontent">
				<table class="formtable">
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="text" name="adtypename" size="60" maxlength="80" class="infoInput"/>
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="text" name="width" value="0" size="10" maxlength="4" class="infoInput"/>
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="text" name="height" value="0" size="10" maxlength="4" class="infoInput"/>
							<span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_size_mess'] ?></span>
						</td>
					</tr>
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="radio" value="1" name="isxml" onclick="showdiv(1,'#xmltemplatefilediv|#xmlfilediv|#xmlpathdiv','0|1','trstyle2 displaynone|trstyle2 displaytrue',1,1)"/> <?php echo $this->_tpl_vars['ST']['open_botton_title'] ?>&nbsp;
							<input type="radio" value="0" name="isxml" checked="checked" onclick="showdiv(0,'#xmltemplatefilediv|#xmlfilediv|#xmlpathdiv','0|1','trstyle2 displaynone|trstyle2 displaytrue',1,1)"/> <?php echo $this->_tpl_vars['ST']['close_botton_title'] ?>
							<span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_isxml_mess'] ?></span>
						</td>
					</tr>
					<tr class="trstyle2 displaynone"  id="xmltemplatefilediv">
						<td class="trtitle011"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_xmltemplatefile'] ?></td>
						<td class="trtitle02">
							<input type="text" name="xmltemplatefile" size="20" maxlength="150" class="infoInput"/>
							<span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_xmltemplatefile_mess'] ?></span>
						</td>
					</tr>
					<tr class="trstyle2 displaynone"  id="xmlfilediv">
						<td class="trtitle011"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_xmlfile'] ?></td>
						<td class="trtitle02">
							<input type="text" name="xmlfile" size="20" maxlength="150" class="infoInput"/>
							<span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_xmlfile_mess'] ?></span
						</td>
					</tr>
					<tr class="trstyle2 displaynone"  id="xmlpathdiv">
						<td class="trtitle011"><?php echo $this->_tpl_vars['ST']['adverttypemain_add_xmlpath'] ?></td>
						<td class="trtitle02">
							<input type="text" name="xmlpath" size="20" maxlength="150" class="infoInput"/>
