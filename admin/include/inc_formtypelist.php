...
$FORMMEMBERTYPE = array(
    0 => array('key' => 'string', 'name' => '单行文本', 'class' => 'text', 'alter' => 'VARCHAR', 'varlong' => '250'),
    1 => array('key' => 'text', 'name' => '多行文本', 'class' => 'textarea', 'alter' => 'TEXT', 'varlong' => '250'),
    2 => array('key' => 'htmltext', 'name' => 'HTML文本', 'class' => 'textarea', 'alter' => 'TEXT', 'varlong' => '250'),
    3 => array('key' => 'int', 'name' => ' 整数类型', 'class' => 'text', 'alter' => 'INT', 'varlong' => '11'),
    4 => array('key' => 'float', 'name' => ' 小数类型', 'class' => 'text', 'alter' => 'FLOAT', 'varlong' => '11'),
    5 => array('key' => 'datetime', 'name' => '时间类型', 'class' => 'text', 'alter' => 'INT', 'varlong' => '11'),
    6 => array('key' => 'select', 'name' => '下拉框', 'class' => 'select', 'alter' => 'VARCHAR', 'varlong' => '250'),
    7 => array('key' => 'radio', 'name' => '单选框', 'class' => 'radio', 'alter' => 'VARCHAR', 'varlong' => '250'),
    8 => array('key' => 'checkbox', 'name' => '多选框', 'class' => 'checkbox', 'alter' => 'VARCHAR', 'varlong' => '250'),
    9 => array('key' => 'selectinput', 'name' => '复合选项关联输入框', 'class' => 'text', 'alter' => 'VARCHAR', 'varlong' => '250'),
    10 => array('key' => 'decimal', 'name' => '价格', 'class' => 'text', 'alter' => 'FLOAT', 'varlong' => '50'),
);
...
$CALLTYPE = array(
	...
	'url' => 'http://wp.qq.com/',
	'style' => array(
	    0 => array('key' => '1', 'name' => '简洁型'),
	    1 => array('key' => '2', 'name' => '标准型'),
	    2 => array('key' => '3', 'name' => '拓展型')
	)
    ),
    1 => array(
	'key' => '2',
...
$LANPACKTYPE = array(
    ...
    '2' => array('key' => '3', 'name' => '网站基本语言'),
    '3' => array('key' => '4', 'name' => '公共'),
    '4' => array('key' => '5', 'name' => '组件'),
);
