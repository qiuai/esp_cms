...
class important extends connector {
	...
	function onsubsave() {
		...
		if ($inputclass == 'add') {
			...
			$db_field = 'pid,mid,lng,subjectname,keywords,description,content,subpic,dirname,purview,isclass,styleid,indextemplates,template,filenamestyle,dirpath,addtime,ishtml,iswap,waptempalte,pagemax,headtitle';
			$db_values = "50,$mid,'$lng','$subjectname','$keywords','$description','$content','$subpic','$dirname',$purview,1,$styleid,'$indextemplates','$template','$filenamestyle','$dirname',$date,$ishtml,$iswap,'$waptempalte',$pagemax,'$headtitle'";
			...
			$db_where = 'sid=' . $sid;
			$db_set = "subjectname='$subjectname',keywords='$keywords',description='$description',content='$content',subpic='$subpic',purview=$purview,styleid=$styleid,indextemplates='$indextemplates',template='$template',filenamestyle='$filenamestyle',ishtml=$ishtml,iswap=$iswap,waptempalte='$waptempalte',pagemax=$pagemax,headtitle='$headtitle'";
