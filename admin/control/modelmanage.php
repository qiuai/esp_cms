...
class important extends connector {
	...
	function onmodeledit() {
		...
		$payplug = $this->get_payplug_array($modelread['opid']);
		$this->ectemplates->assign('payplug', $payplug['list']);
		if ($type == 'copy') {
	...
	function onmodelsave() {
		...
		$pagemax = intval($this->fun->accept('pagemax', 'P'));
		$pagesylte = intval($this->fun->accept('pagesylte', 'P'));
		$isbase = intval($this->fun->accept('isbase', 'P'));
		$istsn = intval($this->fun->accept('istsn', 'P'));
		$isalbum = intval($this->fun->accept('isalbum', 'P'));
		$isextid = intval($this->fun->accept('isextid', 'P'));
		$issid = intval($this->fun->accept('issid', 'P'));
		$isfgid = intval($this->fun->accept('isfgid', 'P'));
		$islinkdid = intval($this->fun->accept('islinkdid', 'P'));
